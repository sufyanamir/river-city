...
<style>
    ...
    * {
    ...
    /* Always transparent scrollbar */
::-webkit-scrollbar {
    width: 8px; /* keep space if needed */
...
/* When printing, remove scrollbar entirely */
@media print {
    body {
                            ...
                            <div class="flex justify-end gap-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-[#858585]">
                                        ...
                                        @endphp
                                        <span id="dynamic-total">${{ number_format($grandTotal, 2) }}</span>
