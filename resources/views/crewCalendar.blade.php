...
<script>
    ...
    var shifts = [{
        start: '2023-11-04T07:00',
        end: '2023-11-04T19:00',
        title: '07:00 - 19:00',
        resource: 2,
        slot: 1
    }, {
        start: '2023-11-04T07:00',
        end: '2023-11-04T13:00',
        title: '07:00 - 13:00',
        resource: 3,
        slot: 1
    }, {
        ...
        start: '2023-11-04T12:00',
        end: '2023-11-04T18:00',
        title: '12:00 - 18:00',
        resource: 4,
        slot: 2
    }, {
        ...
        start: '2023-11-05T07:00',
        end: '2023-11-05T13:00',
        title: '07:00 - 13:00',
        resource: 1,
        slot: 1
    }, {
        ...
        start: '2023-11-06T07:00',
        end: '2023-11-06T13:00',
        title: '07:00 - 13:00',
        resource: 1,
        slot: 1
    }, {
        ...
        start: '2023-11-06T12:00',
        end: '2023-11-06T18:00',
        title: '12:00 - 18:00',
        resource: 2,
        slot: 2
    }, {
        ...
        start: '2023-11-07T07:00',
        end: '2023-11-07T13:00',
        title: '07:00 - 13:00',
        resource: 5,
        slot: 1
    }, {
        ...
        start: '2023-11-07T12:00',
        end: '2023-11-07T18:00',
        title: '12:00 - 18:00',
        resource: 2,
        slot: 2
    }, {
        ...
        start: '2023-11-08T07:00',
        end: '2023-11-08T13:00',
        title: '07:00 - 13:00',
        resource: 1,
        slot: 1
    }, {
    ...
    var invalid = [{
        start: '2023-11-05T00:00',
        end: '2023-11-05T23:59',
        resource: 4,
        slot: 1
    }, {
        start: '2023-11-05T00:00',
    ...
    function createAddPopup(args) {
        ...
        popup.setOptions({
            headerText: '<div>New shift</div><div class="employee-shifts-day">' +
                formatDate('DDDD', new Date(tempShift.start)) + ' ' + slot.name + ',' + formatDate(
                    'DD MMMM YYYY', new Date(tempShift.start)) + '</div>',
            buttons: [
                'cancel',
                {
                    text: 'Add',
    ...
    function createEditPopup(args) {
        ...
        var headerText = '<div>Edit ' + resource.name + '\'s hours</div><div class="employee-shifts-day">' +
            formatDate('DDDD', new Date(ev.start)) + ' ' + slot.name + ',' + formatDate('DD MMMM YYYY', new Date(ev
                .start)) + '</div>';
                ...
                'cancel',
                {
                    ...
                    handler: function() {
                        ...
                        calendar.updateEvent({
                            id: ev.id,
                            title: formatDate('HH:mm', date[0]) + ' - ' + formatDate('HH:mm',
    ...
    range = mobiscroll.datepicker('#demo-employee-shifts-date', {
        ...
        onChange: function(args) {
            ...
            tempShift.title = formatDate('HH:mm', date[0]) + ' - ' + formatDate('HH:mm', date[1] ? date[1] :
                date[0]);
        }
    });
