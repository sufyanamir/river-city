    ...
    <div class=" bg-white w-full rounded-lg shadow-lg">
        <div class="pb-5">
            <div class="bg-[#930027] mt-5">
                <h2 class="py-3 text-center text-[#FFFFFF] text-[18px]/[27px] font-semibold">Quotation</h2>
            </div>
            <div class=" px-4">
                <form action="">
                    <div class="mt-10 mb-6 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 m-3">
                        ...
                        <div class="sm:col-span-6 flex justify-between gap-7">
                        ...
                        <div class="sm:col-span-6 flex justify-between gap-11">
