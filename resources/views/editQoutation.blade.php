                ...
                <form action="">
                    ...
                    <div class=" sm:col-span-3 flex justify-between">
                        ...
                        <div class="sm:col-span-6 flex justify-between">
                            ...
                            <input type="text" name="address" id="address" placeholder="Phone Number" class="   ml-1 pl-2 w-[95%] outline-none rounded-md border-0 py-1.5 text-gray-400 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#0095E5] sm:text-sm sm:leading-6">
                        </div>
                        <div class="sm:col-span-3 flex justify-between">
                            <label for="sceduler" class=" text-sm font-medium leading-6 text-gray-900">Sceduler</label>
                            <select id="sceduler" name="customer" autocomplete="customer-name" class=" ml-1 pl-2 w-[90%] outline-none rounded-md border-0 py-1.5 text-gray-400 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#0095E5] sm:text-sm sm:leading-6">
                        ...
                        <div class="sm:col-span-3 flex justify-between">
                            <label for="date" class=" text-sm font-medium leading-6  text-black">Schedule <br>
                                Date Time</label>
                            <input type="date" name="first-name" id="first-name" autocomplete="given-name" class=" ml-1 pl-2 w-[85%] outline-none rounded-md border-0 py-1.5 text-gray-400 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#0095E5] sm:text-sm sm:leading-6">
                        </div>
                        <div class="sm:col-span-6 flex justify-between">
                            <label for="note" class=" text-sm font-medium leading-6  text-black">Note</label>
                            <textarea  name="note" id="note" placeholder="Note" class="   ml-1 pl-2 w-[95%] outline-none rounded-md border-0 py-1.5 text-gray-400 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#0095E5] sm:text-sm sm:leading-6"></textarea>
                        </div>

                    </div>
                    <div class="border-t text-right ">
                        <x-add-button :title="'Update'" :class="'m-5 px-6'" :id="''"></x-add-button>
                    </div>
                </form>
            </div>
        </div>
