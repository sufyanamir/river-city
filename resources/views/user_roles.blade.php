                ...
                <table id="universalTable" class="display" style="width:100%">
                    ...
                    <tbody id="universalTableBody" class=" text-sm">
                        @foreach ($user_roles as $item)
                            <tr>
                                <td><img class=" w-18 h-18 rounded-full"
                                        src="{{ asset('assets/images/demo-user.svg') }}" alt="image"></td>
                                <td>{{ $item['departement'] }}</td>
                                <td>{{ $item['role'] }}</td>
                                <td>
                                    <form action="/delete/userRole/{{ $item['user_role_id'] }}" id="formData"
                                        method="post">
                                        @csrf
                                        <button>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class=" text-center grid grid-cols-1 gap-2">
                        ...
                        <div class=" my-2">
                            ...
                            <input type="text" required name="role" id="role" placeholder="Enter Role"
