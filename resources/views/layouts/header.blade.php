  ...
  <div class="sidebar duration-500 fixed top-0 bottom-0 lg:left-0 w-[250px] overflow-y-auto text-center bg-[#930027]">
    <div class="text-gray-100 text-xl">
      <div class="p-2.5 mt-1 flex items-center">
        ...
        <i class="bi bi-x cursor-pointer  ml-6 " onclick="openSidebar()"></i>
      </div>
    </div>
    ...
    <x-sidebarLinks :class="'text-white'" :title="'Dashboard'" :icon="'dashboard-icon.svg'"></x-sidebarLinks>
    <x-sidebarLinks :class="'text-white'" :title="'Customers'" :icon="'user-icon.svg'"></x-sidebarLinks>
    <x-sidebarLinks :class="'text-white'" :title="'Estimates'" :icon="'estimate-icon.svg'"></x-sidebarLinks>
    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer mx-5 hover:bg-[#edf2f7] hover:text-[#930027] text-white" id="dropdown-card1" onclick="dropdown('submenu1','arrow1', 'dropdown-card1', 'dropdown-text1')">
    ...
    <div class="text-left text-sm mt-2 w-4/5 mx-auto text-gray-200 duration-300 font-bold hidden" id="submenu1">
      <x-sidebarLinks :class="'bg-white text-[#930027]'" :title="'Items'" :icon="'item-icon.svg'"></x-sidebarLinks>
      <x-sidebarLinks :class="'bg-white text-[#930027]'" :title="'Groups'" :icon="'group-icon.svg'"></x-sidebarLinks>
    </div>
    <x-sidebarLinks :class="'text-white'" :title="'Calendar'" :icon="'calendar-icon.svg'"></x-sidebarLinks>
    <x-sidebarLinks :class="'text-white'" :title="'Campaign'" :icon="'campaign-icon.svg'"></x-sidebarLinks>
    <x-sidebarLinks :class="'text-white'" :title="'Reports'" :icon="'reports-icon.svg'"></x-sidebarLinks>
    <x-sidebarLinks :class="'text-white'" :title="'Email Templates'" :icon="'emailTemplate-icon.svg'"></x-sidebarLinks>
    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer mx-5 hover:bg-[#edf2f7] hover:text-[#930027] text-white" id="dropdown-card2" onclick="dropdown('submenu2','arrow2', 'dropdown-card2', 'dropdown-text2')">
    ...
    <div class="text-left text-sm mt-2 w-4/5 mx-auto text-gray-200 font-bold hidden" id="submenu2">
      <x-sidebarLinks :class="'bg-white text-[#930027]'" :title="'Users'" :icon="'user-icon.svg'"></x-sidebarLinks>
      <x-sidebarLinks :class="'bg-white text-[#930027]'" :title="'User role'" :icon="'userRole-icon.svg'"></x-sidebarLinks>
    </div>
    <x-sidebarLinks :class="'text-white'" :title="'Settings'" :icon="'settings-icon.svg'"></x-sidebarLinks>
    <x-sidebarLinks :class="'text-white'" :title="'Help'" :icon="'help-icon.svg'"></x-sidebarLinks>
