...
<html>
  ...
  <body class="bg-blue-600">
    ...
    <div
      class="sidebar fixed top-0 bottom-0 lg:left-0 w-[250px] overflow-y-auto text-center bg-gray-900"
    >
      <div class="text-gray-100 text-xl">
        <div class="p-2.5 mt-1 flex items-center">
          ...
          <i
            class="bi bi-x cursor-pointer ml-16 "
            onclick="openSidebar()"
          ></i>
        </div>
    ...
    <script type="text/javascript">
      ...
      function openSidebar() {
        document.querySelector(".sidebar").classList.toggle("w-[0px]");
      }
    </script>
  </body>
</html>
