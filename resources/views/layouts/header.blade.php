...
<body class="bg-[#930027]">
    ...
    <div class="sidebar duration-500 fixed top-0 bottom-0 lg:left-0 w-[250px] overflow-y-auto text-center bg-[#930027]">
        ...
        <x-sidebar-links :class="'text-white'" :url="'/dashboard'" :title="'Dashboard'" :icon="'dashboard-icon.svg'"></x-sidebar-links>
        ...
        <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer mx-5 hover:bg-[#edf2f7] hover:text-[#930027] text-white" id="crew-dropdown-card1">
        ...
        <div class="text-left text-sm mt-2 w-4/5 mx-auto text-gray-200 duration-300 font-bold hidden" id="crew-submenu1">
            ...
            <x-sidebar-links :class="'bg-white text-[#930027]'" :url="'/completeJobs'" :title="'Complete'" :icon="'group-icon.svg'"></x-sidebar-links>
            <x-sidebar-links :class="'bg-white text-[#930027]'" :url="'/pendigJobs'" :title="'Pending'" :icon="'item-icon.svg'"></x-sidebar-links>
            <x-sidebar-links :class="'bg-white text-[#930027]'" :url="'/approvedJobs'" :title="'Approved'" :icon="'group-icon.svg'"></x-sidebar-links>
            <x-sidebar-links :class="'bg-white text-[#930027]'" :url="'/cancelJobs'" :title="'Cancel'" :icon="'group-icon.svg'"></x-sidebar-links>
        </div>
        <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer mx-5 hover:bg-[#edf2f7] hover:text-[#930027] text-white" id="user-dropdown-card1">
            <img src="{{ asset('assets/icons/estimate-icon.svg') }}" alt="">
            <div class="flex justify-between w-full items-center">
        ...
        <div class="text-left text-sm mt-2 w-4/5 mx-auto text-gray-200 duration-300 font-bold hidden" id="user-submenu1">
            ...
            <x-sidebar-links :class="'bg-white text-[#930027]'" :url="'/completeEstimates'" :title="'Complete'" :icon="'group-icon.svg'"></x-sidebar-links>
            <x-sidebar-links :class="'bg-white text-[#930027]'" :url="'/pendigEstimates'" :title="'Pending'" :icon="'item-icon.svg'"></x-sidebar-links>
            <x-sidebar-links :class="'bg-white text-[#930027]'" :url="'/approvedEstimates'" :title="'Approved'" :icon="'group-icon.svg'"></x-sidebar-links>
            <x-sidebar-links :class="'bg-white text-[#930027]'" :url="'/cancelEstimates'" :title="'Cancel'" :icon="'group-icon.svg'"></x-sidebar-links>
        </div>
        ...
        <div class="text-left text-sm mt-2 w-4/5 mx-auto text-gray-200 duration-300 font-bold hidden" id="submenu1">
            ...
            <x-sidebar-links :class="'bg-white text-[#930027]'" :url="'/group'" :title="'Groups'" :icon="'group-icon.svg'"></x-sidebar-links>
        </div>
        <x-sidebar-links :class="'text-white'" :url="'/calendar'" :title="'Calendar'" :icon="'calendar-icon.svg'"></x-sidebar-links>
        <x-sidebar-links :class="'text-white'" :url="'/crewCalendar'" :title="'Crew Calendar'" :icon="'calendar-icon.svg'"></x-sidebar-links>
        ...
        <div class="text-left text-sm mt-2 w-4/5 mx-auto text-gray-200 font-bold hidden" id="submenu2">
            <x-sidebar-links :class="'bg-white text-[#930027]'" :url="'/users'" :title="'Users'" :icon="'user-icon.svg'"></x-sidebar-links>
            <x-sidebar-links :class="'bg-white text-[#930027]'" :url="'/userRole'" :title="'User role'" :icon="'userRole-icon.svg'"></x-sidebar-links>
        </div>
