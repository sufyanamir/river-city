...
<head>
  ...
  <body class="bg-[#930027]">
    ...
    <div class="sidebar duration-500 fixed top-0 bottom-0 lg:left-0 w-[250px] overflow-y-auto text-center bg-[#930027]">
      ...
      <div  class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer mx-5 hover:bg-[#edf2f7] hover:text-[black] text-white" onclick="dropdown('submenu1','arrow1')">
      ...
      <div class="text-left text-sm mt-2 w-4/5 mx-auto text-gray-200 font-bold hidden" id="submenu1">
        <x-sidebarLinks :title="'Items'" :icon="'item-icon.svg'"></x-sidebarLinks>
        <x-sidebarLinks :title="'Groups'" :icon="'group-icon.svg'"></x-sidebarLinks>
      </div>
      <x-sidebarLinks :title="'Calendar'" :icon="'calendar-icon.svg'"></x-sidebarLinks>
      <x-sidebarLinks :title="'Campaign'" :icon="'campaign-icon.svg'"></x-sidebarLinks>
      <x-sidebarLinks :title="'Reports'" :icon="'reports-icon.svg'"></x-sidebarLinks>
      <x-sidebarLinks :title="'Email Templates'" :icon="'emailTemplate-icon.svg'"></x-sidebarLinks>
      <div  class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer mx-5 hover:bg-[#edf2f7] hover:text-[black] text-white" onclick="dropdown('submenu2','arrow2')">
        ...
        <div class="flex justify-between w-full items-center">
          <span class="text-[15px] ml-4 text-black-600 font-bold">Users</span>
      ...
      <div class="text-left text-sm mt-2 w-4/5 mx-auto text-gray-200 font-bold hidden" id="submenu2">
        <x-sidebarLinks :title="'Users'" :icon="'user-icon.svg'"></x-sidebarLinks>
        <x-sidebarLinks :title="'User role'" :icon="'userRole-icon.svg'"></x-sidebarLinks>
      </div>
      <x-sidebarLinks :title="'Settings'" :icon="'settings-icon.svg'"></x-sidebarLinks>
      <x-sidebarLinks :title="'Help'" :icon="'help-icon.svg'"></x-sidebarLinks>
