                    ...
                    if ($itemQty != null) {
                        ...
                        if ($item) {
                            ...
                            $estimateItem = EstimateItem::create([
                                ...
                                'labour_expense' => number_format($item->labour_expense, 2),
                                'material_expense' => number_format($item->material_expense, 2),
                                'item_qty' => $itemQty,
    ...
    public function estimateItems(Request $request)
    {
        try {
            ...
            $estimateItem = EstimateItem::create([
                ...
                'item_cost' => number_format($validatedData['item_cost'], 2),
                'item_price' => number_format($validatedData['item_price'], 2),
                'labour_expense' => number_format($validatedData['labour_expense'], 2),
                'material_expense' => number_format($validatedData['material_expense'], 2),
                'item_qty' => $validatedData['item_qty'],
                'item_total' => number_format($validatedData['item_total'], 2),
                'item_Description' => $validatedData['item_description'],
